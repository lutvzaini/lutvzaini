...
<details>
  ...
  <p>
   ...
   <p>
      <img alt="Cloud Hosting/SaaS, CI/CD, Automation, VM, Infrastructure-as-Code (IaC), Orchestration" src="https://img.shields.io/static/v1?logo=&label=&message=⚡️ Cloud Hosting/SaaS, CI/CD, Automation, VM, Infrastructure-as-Code (IaC), Orchestration :&color=fff&logoColor=fff&style=square" />
